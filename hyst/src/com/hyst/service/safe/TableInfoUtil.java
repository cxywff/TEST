...
public class TableInfoUtil {
	 ...
	 */
	@Autowired
	private static OrgnizationDao orgnizationDao;
	@Autowired
	private static TableOperDao tableOperDao;

	public static void setTableOperDao(TableOperDao tableOperDao) {
		TableInfoUtil.tableOperDao = tableOperDao;
	}
	
	public static void setOrgnizationDao(OrgnizationDao orgnizationDao) {
		TableInfoUtil.orgnizationDao = orgnizationDao;
	}
	 ...
	 * @return 包含子菜单的父菜单的集合
	 */
	public static List<TableInfo> getSonTable(List<TableInfo> flist,TableInfoDao tableInfoDao){
	...
	public static void setTableOpers(List<TableInfo> slist){
